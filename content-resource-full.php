...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-footer">
		...
		<?php endif; ?>
				<li><a href="<?php $library = get_page_by_title( __('Resource Library', 'gei') ); echo get_page_link( $library->ID );  ?>"><i class="fa fa-angle-left"></i> <?php _e( 'Return to Library', 'gei' ); ?></a></li>
			</ul>
		</section>
